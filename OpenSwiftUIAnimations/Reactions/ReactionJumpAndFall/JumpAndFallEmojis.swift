...
extension View {
    func emojiJumpAndFall(trigger: Binding<Int>) -> some View {
...
struct EmojiReactionModifier: ViewModifier {
...
struct JumpAndFallEmojis: View {
    ...
    var body: some View {
        HStack {
            ...
            .emojiJumpAndFall(trigger: $heartReactionCount)
            ...
            .emojiJumpAndFall(trigger: $upReactionCount)
            ...
            .emojiJumpAndFall(trigger: $downReactionCount)
            ...
            .emojiJumpAndFall(trigger: $lolReactionCount)
            ...
            .emojiJumpAndFall(trigger: $wutReactionCount)
        }
    }
}
